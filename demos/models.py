...
class ParkingLot(models.Model):
    ...
    average_rating = models.FloatField(null=True, default=0) # 평균 평점
    available_spots = models.IntegerField(null=True, default=None)  # 주차 가능한 자리 수
...
class UserFavoriteParking(models.Model):
    ...
    class Meta:
        unique_together = ('user', 'parking_lot')  # 중복 찜 방지
